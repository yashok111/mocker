...
export function ScenariosPage({ id }: { id: number }): ReactElement {
  ...
  return (
    <div data-testid="scenarios-page">
      <Stack gap="md">
        <Title order={2}>Сценарии</Title>
        <Text size="sm" c="dimmed">
          Сценарий подставляет сохранённые настройки и правки операций поверх воркспейса.
          Деактивация возвращает исходный слой. Свои эндпоинты в снимок не входят — они на вкладке{" "}
